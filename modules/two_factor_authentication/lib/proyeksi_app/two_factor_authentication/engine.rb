...
module ProyeksiApp::TwoFactorAuthentication
  class Engine < ::Rails::Engine
    engine_name :proyeksiapp_two_factor_authentication

    include ProyeksiApp::Plugins::ActsAsOpEngine

    register 'proyeksiapp-two_factor_authentication',
             ...
             bundled: true do
               menu :my_menu,
                    ...
                    after: :password,
                    if: ->(*) { ::ProyeksiApp::TwoFactorAuthentication::TokenStrategyManager.enabled? },
               ...
               menu :admin_menu,
                    ...
                    if: ->(*) { ::ProyeksiApp::TwoFactorAuthentication::TokenStrategyManager.configurable_by_ui? }
             end
    ...
    add_tab_entry :user,
                  ...
                  only_if: ->(*) { User.current.admin? && ProyeksiApp::TwoFactorAuthentication::TokenStrategyManager.enabled? }

    config.to_prepare do
      # Verify the validity of the configuration
      ::ProyeksiApp::TwoFactorAuthentication::TokenStrategyManager.validate_configuration!
    end

    config.after_initialize do
      ProyeksiApp::Authentication::Stage.register(:two_factor_authentication,
                                                  nil,
                                                  run_after_activation: true,
                                                  active: -> {
                                                            ::ProyeksiApp::TwoFactorAuthentication::TokenStrategyManager.enabled?
                                                          }) do
