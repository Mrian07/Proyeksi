module ProyeksiApp::TwoFactorAuthentication
  module TokenStrategyManager
    class << self
      ...
      def configuration
        config = ProyeksiApp::Configuration['2fa'] || {}
      ...
      def enforced_by_configuration?
        enforced = (ProyeksiApp::Configuration['2fa'] || {})[:enforced]
      ...
      def lookup_active_strategy(klazz)
        ::ProyeksiApp::TwoFactorAuthentication::TokenStrategy.const_get klazz.to_s.camelize
      rescue NameError => e
