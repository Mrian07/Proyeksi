...
module ProyeksiApp::PDFExport::ExportCard
  require "proyeksi_app/pdf_export/export_card/model_display/work_package_display"
  class DocumentGenerator
    ...
    def patch_models
      ...
      WorkPackage.include ProyeksiApp::PDFExport::ExportCard::ModelDisplay::WorkPackageDisplay
    end
  end
end
