  ...
  module NotificationHandler
    module Helper
      ...
      def extract_work_package_ids(text)
        # matches the following things (given that `Setting.host_name` equals 'www.proyeksiapp.org')
        #  - http://www.proyeksiapp.org/wp/1234
        #  - https://www.proyeksiapp.org/wp/1234
        #  - http://www.proyeksiapp.org/work_packages/1234
        #  - https://www.proyeksiapp.org/projects/:identifier/work_packages/1234
        #  - https://www.proyeksiapp.org/projects/:identifier/wp/1234
        #  - https://www.proyeksiapp.org/any/sub/directories/work_packages/1234
