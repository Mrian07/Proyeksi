...
describe ProyeksiApp::GithubIntegration::Services::UpsertPullRequest do
  ...
  let(:upsert_github_user_service) { instance_double(ProyeksiApp::GithubIntegration::Services::UpsertGithubUser) }

  before do
    allow(ProyeksiApp::GithubIntegration::Services::UpsertGithubUser).to receive(:new).and_return(upsert_github_user_service)
