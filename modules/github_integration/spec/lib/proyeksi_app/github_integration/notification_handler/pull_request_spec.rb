...
describe ProyeksiApp::GithubIntegration::NotificationHandler::PullRequest do
  ...
  let(:upsert_service) { instance_double(ProyeksiApp::GithubIntegration::Services::UpsertPullRequest) }
  ...
  before do
    ...
    allow(ProyeksiApp::GithubIntegration::Services::UpsertPullRequest).to receive(:new).and_return(upsert_service)
