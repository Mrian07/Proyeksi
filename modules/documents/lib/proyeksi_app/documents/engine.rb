...
module ProyeksiApp::Documents
  class Engine < ::Rails::Engine
    engine_name :proyeksiapp_documents

    include ProyeksiApp::Plugins::ActsAsOpEngine

    register 'proyeksiapp-documents',
             author_url: "http://www.proyeksiapp.org",
             bundled: true do
      menu :project_menu,
           :documents,
    ...
    config.to_prepare do
      ...
      require_dependency 'proyeksi_app/documents/patches/textile_converter_patch'
    end
  end
end
