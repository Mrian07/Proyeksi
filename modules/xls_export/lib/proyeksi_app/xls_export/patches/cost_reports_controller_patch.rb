module ProyeksiApp::XlsExport::Patches
  module CostReportsControllerPatch
    ...
    module InstanceMethods
      ...
      def report_to_xls
        ...
        ::ProyeksiApp::XlsExport::XlsViews::CostEntryTable.generate(options).xls
      end
    end
  end
end

CostReportsController.include ProyeksiApp::XlsExport::Patches::CostReportsControllerPatch
