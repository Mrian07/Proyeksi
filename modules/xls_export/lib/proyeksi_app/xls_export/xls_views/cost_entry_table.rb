class ProyeksiApp::XlsExport::XlsViews::CostEntryTable < ProyeksiApp::XlsExport::XlsViews
  def generate
    @spreadsheet = ProyeksiApp::XlsExport::SpreadsheetBuilder.new(I18n.t(:label_money))
