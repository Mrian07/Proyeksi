...
describe ProyeksiApp::Reporting::DefaultData do
  let(:seeder) { BasicData::RoleSeeder.new }
  let(:project_admin) { ProyeksiApp::Reporting::DefaultData.project_admin_role }
  let(:permissions) do
    ProyeksiApp::Reporting::DefaultData.restricted_project_admin_permissions
  end
