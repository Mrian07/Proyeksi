...
class MailHandler < ActionMailer::Base
  ...
  #   or a message)
  #
  # ProyeksiApp includes the necessary references in the References header of outgoing mail (see ApplicationMailer).
  ...
  #
  # ProyeksiApp also sets the Message-ID header but gateways such as postmark, unless explicitly instructed otherwise,
  ...
  def create_attachment(attachment, container)
    file = ProyeksiApp::Files.create_uploaded_file(
