...
3. The **new features block** displays feature announcements and developments of the latest releases of ProyeksiApp.
...
7. The **ProyeksiApp Community block** displays links to important community information, such as release notes, forum, or the API documentation.
...
9. The **Billing block** will be displayed for the [ProyeksiApp Cloud Edition](../../enterprise-guide/enterprise-cloud-guide). The **Enterprise Edition** block will be displayed for the [ProyeksiApp Enterprise Edition](../../enterprise-guide/enterprise-on-premises-guide)). You will get links to the respective section.
