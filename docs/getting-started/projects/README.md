...
sidebar_navigation:
  title: Projects
  priority: 900
description: Introduction to projects in ProyeksiApp.
robots: index, follow
keywords: open project, create project, projects introduction
---
# Projects introduction

Get an introduction how to work with projects in ProyeksiApp. To start collaboration in ProyeksiApp, you first have to set up a new project.
...
A project in ProyeksiApp can be understood as a project as defined above. Also, it can be set up as a "workspace" for teams to collaborate on one common topic, e.g. to organize a department.
