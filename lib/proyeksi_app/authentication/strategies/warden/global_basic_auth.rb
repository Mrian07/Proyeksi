    ...
    module Strategies
      module Warden
        ...
        class GlobalBasicAuth < ::Warden::Strategies::BasicAuth
          ...
          def self.configure!(config = proyeksiapp_config)
          ...
          ##
          # Reads the configuration for this strategy from ProyeksiApp's `configuration.yml`.
          def self.proyeksiapp_config
          ...
          def valid?
            (
              ProyeksiApp::Configuration.apiv3_enable_basic_auth? &&
