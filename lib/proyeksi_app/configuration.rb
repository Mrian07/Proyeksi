...
module ProyeksiApp
  module Configuration
    ...
    ENV_PREFIX ||= 'PROYEKSIAPP_'.freeze
    ...
    @defaults = {
      ...
      # which will be uploaded directly to the cloud storage rather than via ProyeksiApp's
      # server process.
      'direct_uploads' => true,
      ...
      'scm_local_checkout_path' => 'repositories', # relative to ProyeksiApp directory
      ...
      'youtube_channel' => 'https://www.youtube.com/c/ProyeksiAppCommunity',
      ...
      'security_badge_url' => "https://releases.proyeksiapp.com/v1/check.svg",
      ...
      'enterprise_trial_creation_host' => 'https://augur.proyeksiapp.com',
      'enterprise_chargebee_site' => 'proyeksiapp-enterprise',
    ...
    class << self
      # Loads the ProyeksiApp configuration file
      # Valid options:
      ...
      def load_config_from_file(filename, env, config)
        if File.file?(filename)
          ...
          if file_config.is_a? Hash
            ...
            warn "#{filename} is not a valid ProyeksiApp configuration file, ignoring."
          end
        end
      end
