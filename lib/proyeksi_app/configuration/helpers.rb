...
module ProyeksiApp
  module Configuration
    ##
    # To be included into ProyeksiApp::Configuration in order to provide
    ...
    module Helpers
      ...
      def enterprise_trial_creation_host
        if Rails.env.production?
          ...
          'https://augur.proyeksiapp-edge.com'
        end
      end
      ...
      def file_uploader
        available_file_uploaders[ProyeksiApp::Configuration.attachments_storage.to_sym]
      end
