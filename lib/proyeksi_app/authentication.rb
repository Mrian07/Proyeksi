require 'proyeksi_app/authentication/manager'

module ProyeksiApp
  ##
  # ProyeksiApp uses Warden strategies for request authentication.
  module Authentication
    class << self
      ...
      # For available scopes please refer to `ProyeksiApp::Authentication::Scope`.
      #
...
Warden::Strategies::BasicAuth.prepend ProyeksiApp::Authentication::AuthHeaders
