...
ProyeksiApp::TextFormatting::Filters::MacroFilter.register(
  ProyeksiApp::TextFormatting::Filters::Macros::Toc,
  ProyeksiApp::TextFormatting::Filters::Macros::CreateWorkPackageLink,
  ProyeksiApp::TextFormatting::Filters::Macros::IncludeWikiPage,
  ProyeksiApp::TextFormatting::Filters::Macros::EmbeddedTable,
  ProyeksiApp::TextFormatting::Filters::Macros::ChildPages
)
