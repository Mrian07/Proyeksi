...
export const PROYEKSIAPP_ROUTES:Ng2StateDeclaration[] = [
  {
    name: 'new_project.**',
    url: '/projects/new',
    loadChildren: () => import('../../features/projects/proyeksiapp-projects.module').then((m) => m.ProyeksiappProjectsModule),
  },
  {
    name: 'root',
    abstract: true,
  ...
  },
  {
    ...
    url: '/api/docs',
    loadChildren: () => import('../../features/api-docs/proyeksiapp-api-docs.module').then((m) => m.ProyeksiappApiDocsModule),
  },
  {
    name: 'boards.**',
    parent: 'optional_project',
    url: '/boards',
    loadChildren: () => import('../../features/boards/proyeksiapp-boards.module').then((m) => m.ProyeksiappBoardsModule),
  },
  {
    name: 'bim.**',
    parent: 'optional_project',
    url: '/bcf',
    loadChildren: () => import('../../features/bim/ifc_models/proyeksiapp-ifc-models.module').then((m) => m.ProyeksiappIfcModelsModule),
  },
  {
    name: 'backlogs.**',
    parent: 'optional_project',
    url: '/backlogs',
    loadChildren: () => import('../../features/backlogs/proyeksiapp-backlogs.module').then((m) => m.ProyeksiappBacklogsModule),
  },
  {
  ...
  },
  {
    ...
    parent: 'optional_project',
    url: '/cost_reports',
    loadChildren: () => import('../../features/reporting/proyeksiapp-reporting.module').then((m) => m.ProyeksiappReportingModule),
  },
  {
    name: 'job-statuses.**',
    parent: 'optional_project',
    url: '/job_statuses',
    loadChildren: () => import('../../features/job-status/proyeksiapp-job-status.module').then((m) => m.ProyeksiappJobStatusModule),
  },
  {
