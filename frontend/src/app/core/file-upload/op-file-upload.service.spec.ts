...
import { ProyeksiaAppFileUploadService, UploadFile, UploadResult } from './op-file-upload.service';

describe('opFileUpload service', () => {
  let injector:TestBed;
  let service:ProyeksiaAppFileUploadService;
  ...
  beforeEach(() => {
    ...
    injector = getTestBed();
    service = injector.get(ProyeksiaAppFileUploadService);
