...
import { ProyeksiappTimeEntriesModule } from 'core-app/shared/components/time_entries/proyeksiapp-time-entries.module';
...
export class ProyeksiappCalendarModule {
}
