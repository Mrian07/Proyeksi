...
import { ProyeksiappContentLoaderModule } from 'core-app/shared/components/op-content-loader/proyeksiapp-content-loader.module';
...
@NgModule({
  ...
  imports: [
    ...
    ProyeksiappContentLoaderModule,
    ScrollingModule,
  ],
  providers: [
    IanBellService,
